...
<style>
  ...
  .lightbox-content {{ 
    ...
    overflow: visible; border-radius: 
    12px; box-shadow: 0 10px 40px 
    rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.08) inset; 
    background: #0b0b0c; 
    }}
  ...
  .lightbox-count {{ 
    ...
    font-weight: 600; text-shadow: 0 1px 2px rgba(0,0,0,0.6); 
    pointer-events: none; 
    padding-top: 4px; 
    }}
  .nav-btn {{
